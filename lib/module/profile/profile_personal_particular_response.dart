...
ProfilePersonalParticularResponse profilePersonalParticularResponseFromJson(
        String str) =>
    ProfilePersonalParticularResponse.fromJson(json.decode(str));

String profilePersonalParticularResponseToJson(
        ProfilePersonalParticularResponse data) =>
    json.encode(data.toJson());

class ProfilePersonalParticularResponse {
  String? employeeId;
  ...
  ProfilePersonalParticularResponse({
    this.employeeId,
    this.drivingLicense,
  ...
  factory ProfilePersonalParticularResponse.fromJson(
